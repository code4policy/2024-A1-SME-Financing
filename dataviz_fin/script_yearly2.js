...
Promise.all([
    d3.csv("3_Statewise_504_ApprovalPercentage_Value.csv"),
    d3.csv("4_Sectorwise_504_ApprovalPercentage_Value.csv")
]).then(function(data) {

    // Graph 1: Loan Approval by State
    createBarChartState(data[0], "#chart5", "Yearly Loan Approval by State", "Loan Approval Rate");

    // Graph 2: Loan Approval by Industry
    createBarChartIndustry(data[1], "#chart6", "Yearly Loan Approval by Industry", "Loan Approval Rate");
});
